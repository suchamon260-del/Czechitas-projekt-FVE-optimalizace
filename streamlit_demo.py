...
2. Vaše data spotřeby se sloučí s modelovanou solární výrobou a provede se simulace chování sestavy  
...
with st.spinner("Počítám..."):
    ...
    st.markdown(
        "Pozn. Z průběhu solární výroby je vidět, že je vhodné fotovoltaickou elektrárnu kombinovat "
